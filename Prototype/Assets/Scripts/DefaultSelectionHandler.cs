...
public class DefaultSelectionHandler : MonoBehaviour, IGvrGazeResponder {
    ...
    {
        GameObject.Find("Vehicle").gameObject.GetComponent<StopSignScenario>().SetSelectionResult("default");
